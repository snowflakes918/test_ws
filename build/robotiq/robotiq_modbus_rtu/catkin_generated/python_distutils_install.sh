...
echo_and_run cd "/home/difadmin/test_ws/src/robotiq/robotiq_modbus_rtu"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/difadmin/test_ws/src/robotiq/robotiq_modbus_rtu/setup.py" \
     \
    build --build-base "/home/difadmin/test_ws/build/robotiq/robotiq_modbus_rtu" \
    install \
    --root="${DESTDIR-/}" \
